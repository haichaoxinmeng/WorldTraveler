...
//	  String pp=StringUtil.bSubstring("Ｑ加ｗ1q@强++++好可爱哦",6);
...
//	  System.out.println(ret);
       ...
       // System.out.println(isValidDouble(null));
        ...
        String keyword = "利浦$Philips全-+自动家     用面^^条机压~ ~&&面机 HR2356/21";
    	String keywor	= transformSolrMetacharactor(keyword.trim());
    	if(keyword.contains(" ")){
    		System.out.println(keyword+"2");
    	}
    	System.out.println(keywor+"1");
    ...
    /**
     * 
      * @Title: transformSolrMetacharactor
      * @Description: Solr特殊字符
      * @param @param input
      * @param @return
      * @return String
      * @throws 
