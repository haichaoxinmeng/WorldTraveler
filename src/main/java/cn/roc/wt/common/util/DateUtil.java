...
public class DateUtil {
    ...
    public static String formatMonth() {
        return format(new Date(), DATE_MONTH);
    }
    /**
     * 将当前日期格式划成"dd"的字符串
     *
    ...
    public static String formatDay() {
        return format(new Date(), DATE_DAY);
    }
     ...
     * @return
     */
    public static long getDateTimeStringToLong(String source) {
        return parseDateTime(source).getTime();
    }
     ...
     * @return 当前日(1-31)
     */
    public static final int getCurrentDate(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        return cal.get(Calendar.DATE);
    }
     ...
     * 获取指定日期的起始日期
     * <p>
     * 如：在4月份时month=4 输出 2014-04-01 00:00:00
     * </p>
     * @param month 月份
     * @return 指定月份的起始时间
     */
    public static final Date getMonthOfStart(int month) {
        Calendar cal = Calendar.getInstance();
     ...
     * @return 指定月份的起始时间
     */
    public static final Date getMonthOfStart(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(Calendar.DATE, 1);
        cal.set(Calendar.HOUR_OF_DAY, 0);
     ...
     * 获取指定时间：该月份的结束时间
     * <p>
     * 如：在4月份时month=4 输出 2014-04-30 59:59:59
     * </p>
     * @param date 时间
     * @return 指定月份的起始时间
     */
    public static final Date getMonthOfEnd(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        //设置日期为本月最大日期
